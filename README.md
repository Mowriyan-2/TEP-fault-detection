...
```
TEP-fault-detection/
├── Tennessee_Eastman_Process_Fault_Detection.ipynb  ← Main notebook (clean, no outputs)
├── Tennessee_Eastman_Process_Fault_Detection.py    ← Python file for production purpose  
